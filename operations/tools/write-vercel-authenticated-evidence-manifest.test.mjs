...
import { computeNormalizedRecordSetSha256, validateAuthenticatedEvidenceManifest, writeAuthenticatedEvidenceManifest } from './write-vercel-authenticated-evidence-manifest.mjs';
...
async function run() {
  ...
  console.log('26 assertions passed');
}
run();
